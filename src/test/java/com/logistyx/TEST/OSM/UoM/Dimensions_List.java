package com.logistyx.TEST.OSM.UoM;
...
public class Dimensions_List {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/DimensionsUOM.csv")
    public void test1(String DimensionsUnitOfMeasure) {
