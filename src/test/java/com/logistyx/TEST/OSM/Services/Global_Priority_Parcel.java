...
import com.logistyx.utilities.AbstractBaseClasses.OSM.Services.OSMBaseGlobalPriorityParcelNotDG;
...
public class Global_Priority_Parcel extends OSMBaseGlobalPriorityParcelNotDG {

    static {

        OSMBaseGlobalPriorityParcelNotDG.shipmentsLabel();
