...
public class Missing_DeliveryAddress_Contact_Name extends OSMBaseMissingDeliveryAddressContactName {

    static {
        OSMBaseMissingDeliveryAddressContactName.shipmentsLabel();
    }
    ...
    public void test1() {
        ...
        assertThat(errorMessage1, is(equalTo("Delivery Address: Contact: Name is missing or invalid")));
