...
public class Missing_ShippingUnits extends OSMBaseMissingShippingUnits {

    static {
        OSMBaseMissingShippingUnits.shipmentsLabel();
    }


    @DisplayName("shipment.ShippingUnit")
    @Test
    public void test1() {
        ...
        assertThat(errorMessage1, is(equalTo("ShippingUnit is missing or invalid")));
