...
public class Global_Priority_Parcel_Failing_APO extends OSMBaseGlobalPriorityParcelNotDGFailingAPO {

    static {
        OSMBaseGlobalPriorityParcelNotDGFailingAPO.shipmentsLabel();
    }
