...
import com.logistyx.utilities.AbstractBaseClasses.OSM.Origins_Destinations.Military_APO_FPO_DPO.Positive.OSMBaseStandardMailMarketingParcelNotDGAPO;
...
public class Standard_Mail_Marketing_Parcel_APO extends OSMBaseStandardMailMarketingParcelNotDGAPO {

    static {

        OSMBaseStandardMailMarketingParcelNotDGAPO.shipmentsLabel();
    ...
    public void test4() {
        ...
        int carrierServiceAFromLabelStart = decodedStringShipments.indexOf("^FT568,203^A0N,33,55^FD") + 23;
    ...
    public void test14() {
        ...
        String carrierServiceF3FromJson = (osmPojoShipments.getPickupAddress().getLocalityName()) + ", " + osmPojoShipments.getPickupAddress().getSubdivisionCode() + " " + osmPojoShipments.getPickupAddress().getPostalCode();
        ...
        assertThat(carrierServiceF3FromJson.toUpperCase(), is(equalTo(carrierServiceF3FromLabel)));
    ...
    public void test16() {
        ...
        int carrierServiceG2FromLabelStart = decodedStringShipments.indexOf("^FT61,202^A0N,30,29^FD") + 22;
