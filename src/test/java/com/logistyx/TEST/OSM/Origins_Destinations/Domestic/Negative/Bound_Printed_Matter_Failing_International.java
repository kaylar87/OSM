...
public class Bound_Printed_Matter_Failing_International extends OSMBaseBoundPrintedMatterNotDGFailingInternational {

    static {
        OSMBaseBoundPrintedMatterNotDGFailingInternational.shipmentsLabel();
    }
    ...
    public void test1() {
        ...
        assertThat(errorMessage1, is(equalTo("ForwarderServiceCode [OSM-BP-MATTER] does not allow international shipments")));
    }
