...
public class Media_Mail_Failing_International extends OSMBaseMediaMailNotDGFailingInternational {

    static {
        OSMBaseMediaMailNotDGFailingInternational.shipmentsLabel();
    }
    ...
    public void test1() {
        ...
        assertThat(errorMessage1, is(equalTo("ForwarderServiceCode [OSM-MEDIA-MAIL] does not allow international shipments")));
    }
