...
public class Bound_Printed_Matter_APO extends OSMBaseBoundPrintedMatterNotDGAPO {

    static {

        OSMBaseBoundPrintedMatterNotDGAPO.shipmentsLabel();
    ...
    @Test
    public void test72() {
        System.out.println("decodedValuesInternational.size() = " + decodedValuesInternational.size());
