package com.logistyx.TEST.OSM.Dangerous_Goods_Limited_Quantity.Positive_No_Diamond_On_Label;


import com.logistyx.utilities.AbstractBaseClasses.OSM.Dangerous_Goods_Limited_Quantity.Positive_No_Diamond_On_Label.OSMBaseParcelSelectDGNOLQD;
...
public class Parcel_Select_DG_NO_LQD extends OSMBaseParcelSelectDGNOLQD {

    static {

        OSMBaseParcelSelectDGNOLQD.shipmentsLabel();
    ...
    @DisplayName("ZPL Carrier service C - 'PS'")
    @Test
    public void test6() {
        ...
        int carrierServiceCFromLabelStart = decodedStringShipments.indexOf("^FT80,115^A0N,33,59^FD") + 22;
    ...
    @DisplayName("ZPL Carrier service E1 - 'PARCEL SELECT'")
    @Test
    public void test8() {
    ...
    @DisplayName("ZPL LQD - Second Horizontal Line - not removed")
    @Test
    public void test43() {

        String secondHorizontalLine = "^FO28,303^GB756,4,4,B^FS";
        assertThat(decodedStringShipments, containsString(secondHorizontalLine));

    }


    @DisplayName("ZPL LQD Carrier service L - 'SP-21015'")
    @Test
    public void test44() {

        String carrierServiceLHardcoded = "^FT444,421^A0N,30,30^FDSP-21015^FS";
        assertThat(decodedStringShipments, not(containsString(carrierServiceLHardcoded)));

    }


    @DisplayName("ZPL LQD Carrier service M - 'LQD LOGO'")
    @Test
    public void test45() {

        String carrierServiceMHardcoded = "^FO579,315^GFA,974,4825,25,:Z64::C355^FS";
        assertThat(decodedStringShipments, not(containsString(carrierServiceMHardcoded)));
