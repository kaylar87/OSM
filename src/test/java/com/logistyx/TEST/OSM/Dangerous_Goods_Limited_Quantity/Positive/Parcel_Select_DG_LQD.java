...
public class Parcel_Select_DG_LQD extends OSMBaseParcelSelectDGLQD {

    static {

        OSMBaseParcelSelectDGLQD.shipmentsLabel();
    ...
    public void test44() {
        ...
        String carrierServiceLHardcoded = "SP-21015";
        int carrierServiceLFromLabelStart = decodedStringShipments.indexOf("^FT444,319^A0N,30,30^FD") + 23;
        String carrierServiceLFromLabel = decodedStringShipments.substring(carrierServiceLFromLabelStart, carrierServiceLFromLabelStart + carrierServiceLHardcoded.length());
        //  System.out.println(carrierServiceLFromLabel);
        assertThat(carrierServiceLHardcoded, is(equalTo(carrierServiceLFromLabel)));
