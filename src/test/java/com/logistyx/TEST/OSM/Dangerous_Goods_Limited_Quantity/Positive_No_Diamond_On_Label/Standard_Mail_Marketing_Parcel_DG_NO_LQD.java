...
public class Standard_Mail_Marketing_Parcel_DG_NO_LQD extends OSMBaseStandardMailMarketingParcelDGNOLQD {

    static {

        OSMBaseStandardMailMarketingParcelDGNOLQD.shipmentsLabel();
