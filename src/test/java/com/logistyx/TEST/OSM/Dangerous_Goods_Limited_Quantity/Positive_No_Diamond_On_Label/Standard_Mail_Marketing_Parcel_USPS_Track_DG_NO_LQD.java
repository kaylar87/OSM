...
import com.logistyx.utilities.AbstractBaseClasses.OSM.Dangerous_Goods_Limited_Quantity.Positive_No_Diamond_On_Label.OSMBaseStandardMailMarketingParcelUSPSTrackDGNOLQD;
...
public class Standard_Mail_Marketing_Parcel_USPS_Track_DG_NO_LQD extends OSMBaseStandardMailMarketingParcelUSPSTrackDGNOLQD {

    static {

        OSMBaseStandardMailMarketingParcelUSPSTrackDGNOLQD.shipmentsLabel();
    ...
    public void test41() {
        ...
        String carrierServiceKHardcoded = "^FT494,224^A0N,30,30^FDSP-21015^FS";
        assertThat(decodedStringShipments, not(containsString(carrierServiceKHardcoded)));
