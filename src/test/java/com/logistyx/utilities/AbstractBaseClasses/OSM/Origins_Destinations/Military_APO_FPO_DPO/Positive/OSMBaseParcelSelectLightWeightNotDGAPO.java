package com.logistyx.utilities.AbstractBaseClasses.OSM.Origins_Destinations.Military_APO_FPO_DPO.Positive;
...
public abstract class OSMBaseParcelSelectLightWeightNotDGAPO {
    ...
    public static Map<String, String> carrierServiceSTCValueAPOFromJsonMap;
    ...
    public static void shipmentsLabel() {
        ...
        requestJsonBodyShipments = "{\n" +
                ...
                "    \"ForwarderServiceCode\": \"OSM-PARCEL-SELECT-LW\",\n" +
...
//            if checkdigit is 10 use 0, otherwise use checkdigit dynamic value
        ...
        carrierServiceSTCValueAPOFromJsonMap = new LinkedHashMap<>();
        carrierServiceFromJson = osmPojoShipments.getForwarderServiceCode();
        switch (carrierServiceFromJson) {
            case "OSM-FIRST-CLASS-MAIL":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-FIRST-CLASS-MAIL", "000");
                break;
            case "OSM-PRIORITY-MAIL":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-PRIORITY-MAIL", "000");
                break;
            case "OSM-BP-MATTER":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-BP-MATTER", "000");
                break;
            case "OSM-MEDIA-MAIL":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-MEDIA-MAIL", "000");
                break;
            case "OSM-PARCEL-SELECT":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-PARCEL-SELECT", "000");
                break;
            case "OSM-STD-MAIL-MP":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-STD-MAIL-MP", "000");
                break;
            case "OSM-PARCEL-SELECT-LW":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-PARCEL-SELECT-LW", "000");
                break;
            case "OSM-GLOBAL-STANDARD":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-GLOBAL-STANDARD", "001");
                break;
            case "OSM-GLOBAL-PRIO":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-GLOBAL-PRIO", "002");
                break;
            case "OSM-GLOBAL-PRIO-EPKT":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-GLOBAL-PRIO-EPKT", "003");
                break;
            case "OSM-GLOBAL-PRIO-PRCL":
                carrierServiceSTCValueAPOFromJsonMap.put("OSM-GLOBAL-PRIO-PRCL", "004");
                break;
        }
        ...
        if (decodeArrListInternational.size() == (osmPojoShipments.getShippingUnits().get(0).getShippingUnitItems().size() + 1)) {
            ...
            if (decodeArrListInternational.size() == 3) {
